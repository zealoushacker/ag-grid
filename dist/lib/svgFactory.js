...
var SvgFactory = (function () {
    ...
    //    return _.loadTemplate(svg);
    //}
    SvgFactory.getFromCacheOrCreate = function (key, data, className) {
        ...
        if (!eCachedImg) {
            ...
            eCachedImg.src = data;
            eCachedImg.className = className;
